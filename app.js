...
var ProGrad_1 = "Bhuvana";
// 1.2 Print `"The driver's name is XXXX"`.
console.log(ProGrad_1);
// 1.3 Create a variable `ProGrad-2` with the navigator's name.
var ProGrad_2 = "Jothivel";
...
console.log(countUpperCaseChars(ProGrad_1+""+ProGrad_2));
console.log(countLowerCaseChars(ProGrad_1+""+ProGrad_2));
